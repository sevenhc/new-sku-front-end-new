<template>
  <v-container>
    ...
    <p>
      ...
      includes accessing, browsing, or registering to use our site.<br />
    ...
    <p>
      ...
      any part of our site without notice. We will not be liable to you if for
      any reason our site is unavailable at any time or for any period. You are
    ...
    <p>
      ...
      published on it. You are permitted to use this material only as expressly
      authorised by us or our licensors.
    </p>
    <p>
      The material and content within our site is made available only for your
      own personal use. Except for material supplied through our Newsku Service,
      you may download or make one hard copy of such material as necessary only
      for the permitted purpose. You must not modify the paper or digital copies
      of any materials you have printed off or downloaded in any way, and you
    ...
    <p>
      ...
      purposes, nor must you distribute, publish, display, create derivative
      works, make available or copy (except as permitted above) any of such
